<?php
  ...
  if (isset($_POST['username']) && isset($_POST['password'])) {
    ...
    $user = $database->user_login($username,$password);
      ...
      <div class="col-lg-6">
        <div class="p-3">
          <div class="text-center">
              ...
              <h3 style="color:#000"><u><strong>Administrator</strong></u></h3>
          ...
          <form method="post">
            ...
            <button class=" form-control btn btn-primary" name="submit">Login as Administrator</button>
